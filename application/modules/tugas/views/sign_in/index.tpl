                ...
                <section class="content">
                    <!-- quick email widget -->
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    <form method="POST" data-toggle="validator" role="form" id="myForm" enctype='multipart/form-data' action="{base_url()}tugas/set/updatedata">
                                        <!-- text input -->
                                        <div class="form-group">
                                            <label>Username</label>
                                            <input type="text" name="username" class="form-control" value="{$tmed->username}" placeholder="Nomer Induk Karyawan" required/>
                                            <input type="hidden" name="id_guru" class="form-control" value="{$tmed->id_guru}" placeholder="Nomer Induk Karyawan" required/>
                                        </div>
                                        <div class="form-group">
