...
{block name=content}
  ...
  {/if}
  <form action="{base_url()}tugas/tugas/inputTugas" method="post" data-toggle="validator" role="form" enctype='multipart/form-data'>
    <!-- Main content -->
    <section class="content">
            ...
            <div class="box box-info">
                <div class="box-header">
                    ...
                    <h3 class="box-title">Tulis tugas siswa</h3>
                    <!-- tools box -->
