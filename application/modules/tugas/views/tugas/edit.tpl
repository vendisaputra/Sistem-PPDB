...
{block name=content}
  ...
  {/if}
  <form action="{base_url()}tugas/tugas/editdata" method="post" data-toggle="validator" role="form" enctype='multipart/form-data'>
    <!-- Main content -->
          ...
          <div class="box-body">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  {form_error('judul')}
                  <input type="hidden" name="id_tugas" class="form-control" value="{$content->id_tugas}" required/>
                </div>
                <div class="form-group">
