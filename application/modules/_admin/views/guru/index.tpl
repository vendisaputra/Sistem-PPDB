        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="well" style="border-radius:0px;height: auto; padding-top:11px; padding-bottom:11px;">
                    <div class="row">
                        <a href="{base_url()}_admin/guru/tambahdata"><button type="button" class="btn btn-info btn-flat btn-sm"><i class="fa fa-plus"></i> Tambah data</button></a>
                    </div>
                </div>
...
<script src="{base_url()}assets/admin/js/guru.js" type="text/javascript"></script>
