        ...
        <div class="col-sm-8">
         ...
         <div class="col-sm-4">
            ...
            <div class="box box-success">
                <div class="box-header">
                    <i class="fa fa-users"></i>
                    <h3 class="box-title">Edit Uang Seragam</h3>
                    <!-- tools box -->
                    <div class="pull-right box-tools">
                      ...
                      <!-- form start -->
                        ...
                        <div class="box-body">
                          <div class="form-group">
                            ...
                            <input type="hidden" name="id_seragam" class="form-control" value="{$kon->id_setting}" placeholder="BRI/BNi/Jateng dsb">
                          </div>
                        </div><!-- /.box-body -->
