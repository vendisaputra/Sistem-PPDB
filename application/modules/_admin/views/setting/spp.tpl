      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header bg-aqua">
            ...
            <h4 class="modal-title" id="myModalLabel">Edit Uang SPP</h4>
          </div>
             ...
             <form role="form" id="myForm" data-toggle="validator">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="content" class="form-control"  placeholder="jumlah sumbangan" required/>
                    <input type="hidden" name="id_sumbangan" class="form-control"  placeholder="Nama Depan">
                  </div>
                </div><!-- /.box-body --> 
          </div>
...
<script src="{base_url()}assets/admin/js/spp.js" type="text/javascript"></script>
