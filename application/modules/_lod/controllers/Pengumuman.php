...
class Pengumuman extends CI_Controller {
	...
	public function index(){
		...
		$jumlah_data = $this->m_main->show_data_order('pengumuman','tanggal_terbit','DESC')->num_rows();

		$this->paggi('_lod/pengumuman/index/',$jumlah_data,10);
		...
		$data = array(
				...
				'pengumuman' => $this->m_main->searchGet('pengumuman',10,$from,'tanggal_terbit','DESC')->result(),
	...
	public function view(){
		...
		$data = array(
				...
				'content' => $this->m_main->whereData('pengumuman', array('id_pengumuman' => $id))->row(),

				'terkait' => $this->m_main->getData_sort('content','6','tgl_terbit','ASC', array('kategori' => 'berita'))->result(),

			);

		$this->parser->parse("pengumuman/dt_view.tpl",$data);
