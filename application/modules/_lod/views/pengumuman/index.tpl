...
{block name=content}
	<div class="posts_sidebar clearfix"><!-- Start posts_sidebar -->
		...
		<div class="posts_areaa col-md-8">
			<div class="row">
				{foreach from=$pengumuman item=$row}
								...
								<div class="quote_post"><!-- Start quote_post -->
									<div class="overflo img-section" data-bg-img="{base_url()}assets/user/img/5.jpg">
										<div class="hz_thumb_post">
											...
											<div class="quote_title"><br/>
												<!--<a href="{base_url()}_lod/pengumuman/view/{$row->id_pengumuman}"><h3>When you are courting a nice girl an hour seems like a second. When you sit on a red-hot cinder a second seems like an hour. That's relativity.</h3>
									...
									<div class="hz_top_post">
										<div class="hz_title_and_meta">
											<a href="{base_url()}_lod/pengumuman/view/{$row->id_pengumuman}">
												<h3 class="hz_title">{$row->judul}</h3>
											</a>
											<div class="hz_meta_post">
												<span class="hz_post_by"><i class="fa fa-user"></i><a href="#">Admin</a></span>
												<span class="hz_date_post"><i class="fa fa-calendar"></i><a href="#">{tgl_indo($row->tanggal_terbit)}</a></span>
									...
									<div class="hz_main_post_content">
										...
										<div class="hz_bottom_post">
											...
											<div class="hz_read_more">
												<a href="{base_url()}_lod/pengumuman/view/{$row->id_pengumuman}">Read More</a>
											</div>
