		...
		<div class="posts_areaa col-md-8 main_grid_layout clearfix">
			<div class="row">
				...
				<div class="grid_layout">
					<!-- hz_post grid_post -->
					{foreach from=$fasilitas item=$row}
						...
						<div class="standard_post">
							...
							<div class="hz_top_post">
								...
								<div class="hz_title_and_meta">
									<a href="{base_url()}_lod/mload/viewfasilitas/{$row->id_content}">
							...
							<div class="hz_main_post_content">
								...
								<div class="hz_bottom_post">
									...
									<div class="hz_read_more">
										<a href="{base_url()}_lod/mload/viewfasilitas/{$row->id_content}">Read More</a>
									</div>
			...
			<div class="row">
				...
				<div class="widget widget_recent_post"><!-- Start widget recent post -->
						...
						<ul class="recent_post">
							{foreach from=$terkait item=$ter}
							<li>
								<figure class="widget_post_thumbnail">
									<a href="{base_url()}_lod/content/view{$ter->kategori}/{$ter->id_content}"><img src="{image($ter->id_content,'thumb')}" height="80" width="80" alt="Appropriately simplify quality imperatives"></a>
								</figure>
								<div class="widget_post_info">
									<h5><a href="{base_url()}_lod/content/view{$ter->kategori}/{$ter->id_content}">{$ter->judul}</a></h5>
									<div class="post_meta">
										
										<span class="date_meta"><a href="#"><i class="fa fa-calendar"></i> {tgl_indo($ter->tgl_terbit)}</a></span>
									</div>
								</div>
							</li>
							{/foreach}
