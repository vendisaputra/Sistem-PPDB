		...
		<div class="main_page col-md-8"><!-- main_page -->
			...
			<div class="main_author"><!-- main_author -->
				<div class="authorInfo"><!-- authorInfo -->
					...
					<p class="authordescrption">{$visi->value}</p>
				</div><!-- // authorInfo -->
			</div><!-- // main_author -->
			...
			<div class="main_author"><!-- main_author -->
				<div class="authorInfo"><!-- authorInfo -->
					...
					<p class="authordescrption">{$misi->value}</p>
				</div><!-- // authorInfo -->
			</div><!-- // main_author --><br/>
		</div><!-- // main_page -->
						...
						<ul class="recent_post">
							...
							<li>
								<figure class="widget_post_thumbnail">
									<a href="{base_url()}_lod/mload/viewfasilitas/{$row->id_content}"><img src="{image($row->id_content,'thumb')}" height="80" width="80" alt="Appropriately simplify quality imperatives"></a>
								</figure>
								<div class="widget_post_info">
									<h5><a href="{base_url()}_lod/mload/viewfasilitas/{$row->id_content}">{$row->judul}</a></h5>
									<div class="post_meta">
