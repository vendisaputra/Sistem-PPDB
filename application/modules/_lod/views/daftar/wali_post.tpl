...
{block name=content}
    ...
    <section class="content">
      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          <form action="{base_url()}_lod/daction/post_wali" method="post">
            <div class="form-group">
              <div class="row">
                <div class="col-md-4">
                  <label for="exampleInputEmail1">Nama Depan</label>
                  <input type="text" class="form-control" name="ndepan" placeholder="Nama depan:" value="{set_value('ndepan')}" >
                  {form_error('ndepan')}
                </div>
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                      ...
                      <input type="number" min="" class="form-control" name="no_hp" placeholder="No Hp" value="{set_value('no_hp')}" />
                      {form_error('no_hp')}
                    </div>
                    <div class="col-md-4">
                      <label for="exampleInputEmail1">No Telp</label>
                      <input type="number" min="" class="form-control" name="no_telp" placeholder="No Telpon" value="{set_value('no_telp')}" />
                      {form_error('no_telp')}
                    </div>                
              </div>
            </div>    
            <div class="form-group">
              <div class="row">
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" name="hubungan" placeholder="Hubungan Keluarga:"  value="{set_value('hubungan')}" />
                  {form_error('hubungan')}
                </div>
                <div class="col-md-4">
                      <label for="exampleInputEmail1">Pendidikan</label>
                      <input type="text" class="form-control" name="pendidikan" placeholder="Pendidikan:"  value="{set_value('pendidikan')}" />
