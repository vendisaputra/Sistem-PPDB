					...
					<div class="video_post post_wrapper">
						...
						<div class="hz_thumb_post">
							<div class="embed-responsive embed-responsive-16by9">
								<img src="{image($content->id_content,'thumb')}" alt="If you are going to use a passage of Lorem Ipsum" class="latest-cover">
							</div>
						</div>	
						...
						<div class="hz_top_post">
							...
							<div class="hz_title_and_meta">
								...
								<div class="hz_meta_post">
									...
									<span class="hz_cat_post"><i class="fa fa-folder-open"></i><a href="#">{$content->kategori}</a></span>
									<span class="hz_date_post"><i class="fa fa-calendar"></i><a href="#">{tgl_indo($content->tgl_terbit)}</a></span>
						...
						<div class="hz_main_post_content">
							...
							<div class="hz_bottom_post">
								<div class="hz_tags">
									<span><a href="#">{$content->kategori}</a></span>
