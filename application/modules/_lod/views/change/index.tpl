      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <form action="{base_url()}_lod/edata/" method="post">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      ...
                      <input type="text" class="form-control" alt="Kosongkan jika tidak ada" name="tmp_lahir" placeholder="Tempat" value="{$tmed->tmp_lahir}" required/>
