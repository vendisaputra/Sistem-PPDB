...
//    |   |   |   |   |- plugin.min.js
$base_url     = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST']; // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir   = '/plugins/source/'; // path from base_url to base of upload folder (with start and final /)
